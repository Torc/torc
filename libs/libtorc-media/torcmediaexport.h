#ifndef TORC_MEDIA_EXP_H_
#define TORC_MEDIA_EXP_H_
...
# ifdef TORC_MEDIA_API
#  define TORC_MEDIA_PUBLIC Q_DECL_EXPORT
# else
#  define TORC_MEDIA_PUBLIC Q_DECL_IMPORT
# endif
#else
# define TORC_MEDIA_PUBLIC
#endif
