#ifndef TORCBASEUIEXPORT_H
#define TORCBASEUIEXPORT_H
...
# ifdef TORC_BASEUI_API
#  define TORC_BASEUI_PUBLIC Q_DECL_EXPORT
# else
#  define TORC_BASEUI_PUBLIC Q_DECL_IMPORT
# endif
#else
# define TORC_BASEUI_PUBLIC
#endif
