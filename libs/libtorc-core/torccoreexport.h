#ifndef TORC_CORE_EXP_H_
#define TORC_CORE_EXP_H_
...
# ifdef TORC_CORE_API
#  define TORC_CORE_PUBLIC Q_DECL_EXPORT
# else
#  define TORC_CORE_PUBLIC Q_DECL_IMPORT
# endif
#else
# define TORC_CORE_PUBLIC
#endif
