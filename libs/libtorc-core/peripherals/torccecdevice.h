...
#define LIBCEC_BASEDEVICE         QString("libCECBaseDevice")      // e.g. CECDEVICE_PLAYBACKDEVICE1 (logical address)
...
#define LIBCEC_PHYSICALADDRESS_DEFAULT    CEC_DEFAULT_PHYSICAL_ADDRESS
#define LIBCEC_HDMIPORT_DEFAULT           CEC_DEFAULT_HDMI_PORT
#define LIBCEC_BASEDEVICE_DEFAULT         QString("auto")
