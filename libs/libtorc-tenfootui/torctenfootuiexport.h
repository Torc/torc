#ifndef TORCTENFOOTUIEXPORT_H
#define TORCTENFOOTUIEXPORT_H
...
# ifdef TORC_TENFOOTUI_API
#  define TORC_TENFOOTUI_PUBLIC Q_DECL_EXPORT
# else
#  define TORC_TENFOOTUI_PUBLIC Q_DECL_IMPORT
# endif
#else
# define TORC_TENFOOTUI_PUBLIC
#endif
