...
{	return "libsamplerate-0.1.8 (c) 2002-2008 Erik de Castro Lopo" ;
} /* src_get_version */
...
{	double scaled_value ;
	...
	{	len -- ;
        ...
        if (!HAVE_CPU_CLIPS_POSITIVE == 0 && scaled_value >= (1.0 * 0x7FFFFFFF))
		{	out [len] = 32767 ;
			continue ;
			} ;
        if (!HAVE_CPU_CLIPS_NEGATIVE == 0 && scaled_value <= (-8.0 * 0x10000000))
		{	out [len] = -32768 ;
			continue ;
			} ;
