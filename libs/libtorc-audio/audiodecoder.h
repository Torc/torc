...
class TORC_AUDIO_PUBLIC AudioDecoder : public TorcDecoder
{
  ...
  protected:
    ...
    int              GetTorcStreamIndex (int AvStreamIndex, TorcStreamTypes Type);
    ...
    virtual void     ProcessSubtitlePacket (AVFormatContext *Context, AVStream* Stream, AVPacket *Packet);
