...
QString AudioOutputBase::QualityToString(int Quality)
{
    switch(Quality)
    {
 ...
 */
bool AudioOutputBase::CanPassthrough(int Samplerate, int Channels, int Codec, int Profile) const
{
 ...
 */
void AudioOutputBase::SetStretchFactorLocked(float Factor)
{
...
int AudioOutputBase::GetBaseAudBufTimeCode(void) const
{
 ...
 * Create AudioSPDIFEncoderDIF encoder and true if successful
 */
bool AudioOutputBase::SetupPassthrough(int Codec, int CodecProfile,
                                       int &TempSamplerate, int &TempChannels)
{
 ...
 */
void AudioOutputBase::Reconfigure(const AudioSettings &Settings)
{
...
AudioOutputSettings* AudioOutputBase::GetOutputSettings(bool Digital)
{
 ...
 * AddData()
 */
void AudioOutputBase::SetTimecode(qint64 Timecode)
{
...
/**
 * Set the effective DAudioSPDIFEncoder rate
 *
 ...
 */
qint64 AudioOutputBase::GetAudiotime(void)
{
 ...
 */
void AudioOutputBase::SetAudiotime(int Frames, qint64 Timecode)
{
 ...
 */
qint64 AudioOutputBase::GetAudioBufferedTime(void)
{
...
void AudioOutputBase::SetSWVolume(int Volume, bool Save)
{
 ...
 */
int AudioOutputBase::CopyWithUpmix(char *Buffer, int Frames, uint &OriginalWaud)
{
 ...
 */
bool AudioOutputBase::AddFrames(void *Buffer, int Frames, qint64 Timecode)
{
 ...
 * Returns false if there's not enough space right now
 */
bool AudioOutputBase::AddData(void *Buffer, int Length,
...
bool AudioOutputBase::NeedDecodingBeforePassthrough(void) const
{
    return false;
}
...
void AudioOutputBase::BufferOutputData(bool Buffer)
{
 ...
 */
int AudioOutputBase::GetAudioData(unsigned char *Buffer, int size, bool FullBuffer,
                                  volatile uint *LocalRaud)
{
...
int AudioOutputBase::ReadOutputData(unsigned char *ReadBuffer, int MaxLength)
{
    (void)ReadBuffer;
    (void)MaxLength;
    return 0;
