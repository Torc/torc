    ...
    m_unmapSurface(NULL)
{
    ...
    if (context && context->hasExtension("GL_NV_vdpau_interop"))
    {
        m_init                  = (TORC_INITNV)     context->getProcAddress("glVDPAUInitNV");
        m_fini                  = (TORC_FININV)     context->getProcAddress("glVDPAUFiniNV");
        m_registerOutputSurface = (TORC_REGOUTSURF) context->getProcAddress("glVDPAURegisterOutputSurfaceNV");
        m_isSurface             = (TORC_ISSURFACE)  context->getProcAddress("glVDPAUIsSurfaceNV");
        m_unregisterSurface     = (TORC_UNREGSURF)  context->getProcAddress("glVDPAUUnregisterSurfaceNV");
        m_surfaceAccess         = (TORC_SURFACCESS) context->getProcAddress("glVDPAUSurfaceAccessNV");
        m_mapSurface            = (TORC_MAPSURF)    context->getProcAddress("glVDPAUMapSurfacesNV");
        m_unmapSurface          = (TORC_UNMAPSURF)  context->getProcAddress("glVDPAUUnmapSurfacesNV");
    }
